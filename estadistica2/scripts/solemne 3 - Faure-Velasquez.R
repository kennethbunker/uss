...
vd  <- data$enpv_bn           # número efectivo de partidos (Y)
vi1 <- data$dep_as            # numero de diputados - H1: a medida que aumenta el tamaño de la asamblea (X1), aumenta el número de partidos (Y)
vi2 <- data$dep_dm            # magnitud del distrito - H2: a medida que aumenta la magnitud del distrito (X2), aumenta el número de partidos (Y)
vi3 <- data$ethnic            # diversidad etnica - H3: a medida que aumenta la diversidad etnica (X3), aumenta el número de partidos (Y)
