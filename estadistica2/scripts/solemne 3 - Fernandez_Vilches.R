...
#data <- read_xlsx("Dropbox/GitHub/uss/estadistica2/data/fernandez_vilches.xlsx")
...
vd  <- data$freedom         # variable dependiente
vi1 <- data$legal                    # variable independiente 1
vi2 <- data$government                # variable independiente 2 
vi3 <- data$police            # variable independiente 3
vi4 <- data$tarrifs            # variable independiente 4
vi5 <- data$regulation            # variable independiente 4
...
## Estadísticas variable independiente 5
mean(vi3, na.rm = T)
sd(vi3, na.rm = T)
min(vi3, na.rm = T)
max(vi3, na.rm = T)
...
boxplot(vd, main="Libertad Económica")
